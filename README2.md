...
- ¿Cómo decidió las opciones técnicas y arquitectónicas utilizadas como parte de su solución?
  siguiendo la documentacion oficial de react e implementando bootstrap para los estilos
- ¿Hay alguna mejora que pueda hacer en su envío?
  si tuviera mas tiempo de entrega, mejoraria los estilos y agregaria los links de las peliculas para poder visualizarlas 
- ¿Qué haría de manera diferente si se le asignara más tiempo?
  implemnetar que contenido el la serie, si es para todo publico o uno especifico, tambien un boton donde se 
  agreguen comentarios calificando la pelicula
